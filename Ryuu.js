...
module.exports = Ryuu = async (Ryuu, mek, _welkom) => {
	try {
		...
		const ownerNumber = [`${owner}@s.whatsapp.net`, `6289695073357@s.whatsapp.net`]
...
Badmin: 'Bot Harus Jadi Admin Kalo Mau Menggunakan Fiturnya', 
        ...
        const troli =  {key: { fromMe: false,remoteJid: "status@broadcast", participant: '0@s.whatsapp.net'}, message: {orderMessage: {itemCount: 2022, status: 200, thumbnail: tamnel, surface: 200, message: `Made By ${ownername}`, orderTitle: 'NekellHaxor', sellerJid: '0@s.whatsapp.net'} } }
//═════════[ VERIFY ]══════════/
//═════════[ Button ]══════════//
...
menu =`Tunggu Beberapa Detik Ya Kak..`
      teks =`NekellHaxor🔥`
      Ryuu.sendMessage(from, { contentText: `${menu}`, footerText: `${teks}`, buttons: [{ buttonId: `${prefix}menu`, buttonText: { displayText: 'BACK💠' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: fakeimage, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
...
menu =`Tunggu Beberapa Detik Ya Kak..`
      teks =`NekellHaxor🔥`
      Ryuu.sendMessage(from, { contentText: `${menu}`, footerText: `${teks}`, buttons: [{ buttonId: `${prefix}menu`, buttonText: { displayText: '💠BACK' }, type: 1 } ], headerType: '🏴‍☠️LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: fakeimage, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
...
if (args[0].startsWith('08')) return fakeyt('Gunakan kode negara Goblok lo')
try {
